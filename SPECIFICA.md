...
Sviluppare una "3D-WebApp" usando WebGL (HTML 5, CSS e contesto webgl o webgl 2), linguaggi JavaScript e GLSL, su browser Chrome.
...
Non si possono usare librerie diverse da quelle messe a disposizione durante il corso, mentre si raccomanda di utilizzare tutto quello che è stato messo a disposizione (glm_utils.js per il caricamento di file .obj, mesh_utils.js, webgl-utils.js, m 4.js, dat.gui.js).
